...
//参数选择：所有任务不预测
public class mpcMapMy2_42ParaSel4 implements Scheduler {
	...
	public mpcMapMy2_42ParaSel4(double theta){
		this.theta = theta;
	}
	public mpcMapMy2_42ParaSel4(){
...
//		try {
//			EvaluateYLW.subD[0].write(String.format("%15s", "mpcMapMy2_42ParaSel4: "));
...
//			if(task.getDepth() == (this.workflowDepth-1)) { //入口任务不预测，其他任务预测到底
////				if(i <= enrySize) {
//					predictTaskNum = 0;
